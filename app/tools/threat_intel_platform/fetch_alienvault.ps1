# PowerShell script to fetch and update threat intelligence from AlienVault OTX
# This script will:
# 1. Set up a .env file with the necessary AlienVault API key
# 2. Run a Python script to fetch the latest threat intelligence
# 3. Update the local database with new IOCs

# Parameters
$API_KEY = "61b8bc7b26584345ce93d6ac72ce015ec6c37e9f1ae37fc99ba2951acbdea1a2"
$HOURS_BACK = 24  # How many hours of threat data to fetch

# Change to the script directory
$scriptPath = Split-Path -Parent $MyInvocation.MyCommand.Path
Set-Location -Path $scriptPath

# Create the Python script for fetching data
$fetchScript = @"
#!/usr/bin/env python3
"""
...
$fetchScript | Out-File -FilePath "fetch_alienvault.py" -Encoding utf8
...
Write-Host "Fetching threat intelligence from AlienVault OTX API..."
Write-Host "API Key: $API_KEY"
Write-Host "Fetching data from the last $HOURS_BACK hours"
python fetch_alienvault.py

# Completion message
Write-Host "`nThreat intelligence update completed."
Write-Host "To view the data, run the Threat Intelligence Platform using run_threat_intel.ps1" 