				...
				<div className="text-center mb-10">
					<div className="steel-gradient text-white py-12 px-6 rounded-lg shadow-lg mb-12">
						...
						<p className="text-lg max-w-3xl mx-auto">
							Scan any domain for surface-level security risks with automated
							risk tagging
						</p>
					</div>
				</div>
						...
						<div className="mb-6 p-5 bg-gray-50 rounded-lg border border-gray-200">
							<label className="flex items-start cursor-pointer">
								...
								<span className="ml-3 text-sm text-gray-800">
									...
									understand that scanning websites without permission may
									violate laws and terms of service. I accept all legal
									responsibility for this scan.
								</span>
							</label>
						</div>
						...
						<div className="p-8">
							...
							<div className="saffron-gradient text-white p-6 rounded-lg shadow-md">
								...
								<p className="text-sm leading-relaxed">
									This tool is in beta and intended for security research
									purposes only. Only scan domains you own or have explicit
									permission to test. Unauthorized scanning may violate computer
									fraud and abuse laws, terms of service agreements, and other
									regulations.
								</p>
							</div>
						</div>
